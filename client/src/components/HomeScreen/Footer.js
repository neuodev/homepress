...
const Footer = () => {
  return (
    <div className='bg-gray-800 text-white py-10  px-5'>
      <div className='md:flex flex-row-reverse justify-between items-center container mx-auto '>
      ...
      <div className='md:flex items-center justify-between container mx-auto border-t pt-6'>
        <p>
